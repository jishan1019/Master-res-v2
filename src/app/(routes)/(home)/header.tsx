...
export default function Header() {
          ...
          return (
                    <>
                              <nav className="bg-secondary px-4">
                              ...
                              <div className="bg-red-700">
                                        <div className="max-w-7xl mx-auto md:flex items-center gap-2 hidden px-3">
                              ...
                              <div className="bg-gray-800 py-4">
                                        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-2 px-3 md:px-0 text-primary-foreground">
