...
export default function RestaurantOpenTimes({ className }: { className?: string }) {
          ...
          return (
                    <DropdownMenu>
                              <DropdownMenuTrigger className={cn("w-fit md:w-2/5 lg:w-1/3 rounded-md h-9 border bg-secondary border-black/30 dark:border-primary-foreground focus:ring-0 focus:outline-none", className)}>
